...
(function() {
  ...
  exports.toGeo = function(geoJson) {
  ...
  exports.multiLineStringToGeos = function(geoJson) {
  ...
  exports.fromGeo = fromGeo = function(geo) {
    return {
      type: 'Feature',
      geometry: {
        type: geo.type || 'Point',
  ...
  exports.fromGeos = function(geos) {
    var geo;
    return {
